    ...
    function get_index($mod){
        switch($mod){
            ...
            case 'index-mst-pihak':
                ...
                // print_r($data);exit;
            break;
            case 'tmp_data_master':
                $data['iduser'] = $this->input->post('iduser');
                $data['tmp_data_master'] = $this->master_data_model->getdata('tmp_data_master', 'result_array');
                $data['opt_user'] = dtuser();
                $data['bread'] = array('header'=>'Temporary', 'subheader'=>'Master Data');
                $data['view']  = "master_data/tmp_data_master/index_tmp_data_master";
                // echo '<pre>';
                // print_r($data);exit;
            break;
    ...
    function get_form($mod){
        ...
        switch($mod){
            ...
            case 'tmp_mst_pihak':
                if($sts=='edit'){
                    $id = $this->input->post('id');
                    $data = $this->master_data_model->getdata('tmp_mst_pihak', 'row_array', $id);
