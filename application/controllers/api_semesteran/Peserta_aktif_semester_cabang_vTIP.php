...
class Peserta_aktif_semester_cabang_vTIP extends REST_Controller
{
    public function __construct($config = 'rest')
    {
        parent::__construct();
        date_default_timezone_set('Asia/Jakarta');
        $this->load->model('api_semesteran_model/Peserta_aktif_semester_cabang_vTIP_model','modelnya');
