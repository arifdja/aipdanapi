...
class Master_kelompok_penerima extends REST_Controller
{
    public function __construct($config = 'rest')
    {
        parent::__construct($config = 'rest');
        date_default_timezone_set('Asia/Jakarta');
        $this->load->model('api_referensi_model/master_kelompok_penerima_model','modelnya');
