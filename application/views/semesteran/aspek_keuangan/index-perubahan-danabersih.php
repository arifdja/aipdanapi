            ...
            <table id="example" class="table table-responsive table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <th rowspan="2" width="10%">Semester II&nbsp;&nbsp;<span class="thn"></span></th>
          ...
          <?php if ($semester == 1) : ?>
            <table id="example" class="table table-responsive table-bordered table-hover">
              <thead>
                <tr>
                  <th rowspan="2" width="30%">URAIAN</th>
                  <th rowspan="2" width="10%">Semester I&nbsp;&nbsp;<span class="thn-filter"></span></th>
              ...
              <form class="form-horizontal" action="<?php echo base_url() . 'semesteran/aspek_keuangan/save_keterangan' ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    ...
                    <a href="<?php echo site_url('semesteran/aspek_keuangan/get_file/' . (isset($data_perubahan_danabersih_ket_smt1[0]->id) ? $data_perubahan_danabersih_ket_smt1[0]->id : '')); ?>">
                      <p><?php echo (isset($data_perubahan_danabersih_ket_smt1[0]->file_lap) ? $data_perubahan_danabersih_ket_smt1[0]->file_lap : ''); ?></p>
                    </a>
                  </div>
                </div>
              ...
              <form class="form-horizontal" action="<?php echo base_url() . 'semesteran/aspek_keuangan/save_keterangan' ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    ...
                    <input type="file" name="filedata">
                    <p style="margin-top:10px;">File harus bertipe pdf,doc atau docx.</p>
                    <a href="<?php echo site_url('semesteran/aspek_keuangan/get_file/' . (isset($data_perubahan_danabersih_ket_smt2[0]->id) ? $data_perubahan_danabersih_ket_smt2[0]->id : '')); ?>">
                      <p><?php echo (isset($data_perubahan_danabersih_ket_smt2[0]->file_lap) ? $data_perubahan_danabersih_ket_smt2[0]->file_lap : ''); ?></p>
                    </a>
                  </div>
                </div>
                <div class="modal-footer with-border">
