            ...
            <table id="example" class="table table-responsive table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <th width="30%">Semester II&nbsp;&nbsp;<span class="thn"></span></th>
                </tr>
          ...
          <?php if ($semester == 1) : ?>
            <table id="example" class="table table-responsive table-bordered table-hover">
              <thead>
                <tr>
                  <th width="40%">URAIAN</th>
                  <th width="30%">Semester I&nbsp;&nbsp;<span class="thn-filter"></span></th>
              ...
              <form class="form-horizontal" action="<?php echo base_url() . 'semesteran/operasional_belanja/save_keterangan' ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    ...
                    <a href="<?php echo site_url('semesteran/operasional_belanja/get_file/' . (isset($data_perubahan_danabersih_ket_smt1[0]->id) ? $data_perubahan_danabersih_ket_smt1[0]->id : '')); ?>">
              ...
              <form class="form-horizontal" action="<?php echo base_url() . 'semesteran/operasional_belanja/save_keterangan' ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    ...
                    <input type="file" name="filedata">
                    <p style="margin-top:10px;">File harus bertipe pdf,doc atau docx.</p>
                    <a href="<?php echo site_url('semesteran/operasional_belanja/get_file/' . (isset($data_perubahan_danabersih_ket_smt2[0]->id) ? $data_perubahan_danabersih_ket_smt2[0]->id : '')); ?>">
