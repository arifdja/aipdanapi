...
<div class="row">
    ...
    <div class="col-md-4">
        <div class="small-box colornya">
            <div class="inner">
              <span><i class="fa fa-money"></i>&nbsp;&nbsp;&nbsp;Iuran</span>
    ...
    <div class="col-md-4">
        <div class="small-box colornya" style="height:30%;">
            <div class="inner">
               <span><i class="fa fa-money"></i>&nbsp;&nbsp;&nbsp;NTIP</span>
              <p style="font-size: 20px; font-weight:bold;">Rp 147.000.000.000.000,-</p>
            </div>
            <!-- <div class="icon">
                <i class="fa fa-money"></i>
...
<div class="row">
        ...
        <div class="nav-tabs-custom">
            <div class="box box-default">
                <div class="box-header with-border">
                    <h3 class="box-title">Grafik Tren Hasil Investasi</h3>
                </div>
                <div class="box-body">
    ...
    <div class="col-md-6">
        <div class="nav-tabs-custom">
            <div class="box box-default">
                <div class="box-header with-border">
                    <h3 class="box-title">Grafik Tren Nilai Iuran</h3>
                </div>
                <div class="box-body">
...
<div class="row">
    <div class="col-md-6">
        <div class="nav-tabs-custom">
            <div class="box box-default">
                <div class="box-header with-border">
                    <h3 class="box-title">Grafik Tren Nilai Fee Pengelolaan AIP</h3>
                </div>
                <div class="box-body">
...
<div class="row">
    <div class="col-md-6">
        <div class="nav-tabs-custom">
            <div class="box box-default">
                <div class="box-header with-border">
                    <h3 class="box-title">Grafik Tren Nilai NTIP</h3>
                </div>
                <div class="box-body">
                    <div id="container-d8"></div>
                </div>
            </div>
        </div>
    </div>
    <div class="col-md-6">
        <div class="nav-tabs-custom">
            <div class="box box-default">
                <div class="box-header with-border">
                    <h3 class="box-title">Grafik Tren Kenaikan/Penurunan Nilai Pasar Aset Investasi</h3>
                </div>
                <div class="box-body">
                     <div id="container-d9"></div>
                </div>
            </div>
        </div>
    </div>
