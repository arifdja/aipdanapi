                ...
                <form class="form-horizontal" action="<?php echo base_url() . 'tahunan/aspek_keuangan/save_keterangan' ?>" method="post" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      ...
                      <a href="<?php echo site_url('tahunan/aspek_keuangan/get_file/' . (isset($data_dana_bersih_ket_thn[0]->id) ? $data_dana_bersih_ket_thn[0]->id : '')); ?>">
                        <p><?php echo (isset($data_dana_bersih_ket_thn[0]->file_lap) ? $data_dana_bersih_ket_thn[0]->file_lap : ''); ?></p>
                      </a>
                    </div>
                  </div>
