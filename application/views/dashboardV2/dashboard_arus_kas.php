...
<script type="text/javascript">
  $('.filter_data').on('click', function() {
    ...
    $.LoadingOverlay("show");
    $.post(host + 'dashboard-tampil-summary/get_arus_kas', param, function(resp) {
      if (resp) {
        ...
        var yChart_invest = [{
            ...
            data: parsing.arr_data_bar_invest,
          },
          {
        ...
        var yChart_operasioanl = [{
            ...
            data: parsing.arr_data_bar_operasioanl,
          },
          {
            name: 'Realisasi Bulanan',
            type: 'line',
        ...
        var yChart_pendanaan = [{
            ...
            data: parsing.arr_data_bar_pendanaan,
          },
          {
            name: 'Realisasi Bulanan',
            type: 'line',
  ...
  $.LoadingOverlay("show");
  $.post(host + 'dashboard-tampil-summary/get_arus_kas', par, function(resp) {
    if (resp) {
      $.LoadingOverlay("hide", true);
      parsing = JSON.parse(resp);
      var xChart = parsing.arr_bln;
