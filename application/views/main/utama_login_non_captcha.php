        ...
        <div class="login-box">
            <div class="login-box-body dsw-border" style="padding-bottom:20px;border-top: 6px solid #3c8dbc; border-bottom: 10px solid #f39c12" >
                <div class="login-logo" style="margin-bottom:30px; border:none">
                    ...
                    <p style="font-size: 14px;margin-top: -25px">Akumulasi Iuran Pensiun</p>
                </div>
                    ...
                    <?php }  ?>
                    <form class="form-horizontal" id="form_sbn" method="POST" action="<?php echo site_url('login/login_user');?>">
                        ...
                        <div class="col-xs-12">
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <input type="text" id="nmuser" class="form-control" name="nmuser" placeholder="Username" maxlength="30" required="required"/>
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-12">
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <input type="password" id="pass" class="form-control" name="password" placeholder="Password" maxlength="255" required="required"/>
                                </div>
                            </div>
                        </div>
