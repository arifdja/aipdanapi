                ...
                <div class="box-body">
                    ...
                    <div class="tab-content">
                                ...
                                <table id="tab_rincian_invest1" class="table table-responsive table-bordered table-hover">
                                    ...
                                    <tfoot style="background-color: #d8d8d8; font-weight: bold;">
                                        <tr>
                                            ...
                                            <td style="text-align: right;"><?=(isset($sum_invest['tanah_bangunan'])) ? (($sum_invest['tanah_bangunan'] != 0 ) ? rupiah($sum_invest['tanah_bangunan']) : '-') : '-';?></td>
                        ...
                        <div id="rincian_hasil_investasi" class="tab-pane fade">
                             <?php include 'index-rincian-hasil-investasi-tsn.php' ;?>
                        </div>
                    </div>
                </div>
			</div>
