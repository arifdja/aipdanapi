          ...
          <div class="box-body">
            <div class="col-md-12">
              <div class="row">
                ...
                <div class="col-md-1">
                  <div class="form-group adm">
                    <a href="javascript:void(0)" title="Add" class="btn btn-primary btn-sm btn-flat"
                      onClick="gensearch('index-ikhtisar_kinerja','index-ikhtisar_kinerja');">
            ...
            <form class="form-horizontal" method="post" enctype="multipart/form-data"
              action="<?php echo site_url('bulanan/ikhtisar_kinerja/save');?>">
                ...
                <div class="col-md-12">
                  <div class="col-md-12" style="background-color: #dae7ef;">
                    <div class="form-group" style="margin-left: 20px;">
                      ...
                      <input type="hidden" name="file_lap"
                        value="<?php echo (isset($data_ikhtisar_kinerja[0]->file) ? $data_ikhtisar_kinerja[0]->file : '');?>">
                      ...
                      <a
                        href="<?php echo site_url('bulanan/ikhtisar_kinerja/get_file/'.(isset($data_ikhtisar_kinerja[0]->id) ? $data_ikhtisar_kinerja[0]->id : '').get_uri());?>">
                        <p><?php echo (isset($data_ikhtisar_kinerja[0]->file) ? $data_ikhtisar_kinerja[0]->file : '');?>
                        </p>
                      </a>
                      <button class="btn btn-primary btn-flat pull-left user-bln" type="submit"
            ...
            <center>
              <object
                data="<?php echo site_url('files/file_bulanan/ikhtisar_kinerja/'.(isset($data_ikhtisar_kinerja[0]->file_lap) ? $data_ikhtisar_kinerja[0]->file_lap : 'x'));?>"
