...
<table cellpadding="4px" cellspacing="0px" border="1" autosize="1" style="color:#000;background:#fff;font-size: 12px">
    ...
    <tbody>
        ...
        <?php endif;?>
        <?php
        $saldo_akhir1 = (!empty($total_danabersih[0]->saldo_akhir) ? $total_danabersih[0]->saldo_akhir : '0');
        $saldo_akhir2 = (!empty($total_danabersih[1]->saldo_akhir) ? $total_danabersih[1]->saldo_akhir : '0');
        $saldo_akhir_bln_lalu1 = (!empty($total_danabersih[0]->saldo_akhir_bln_lalu) ? $total_danabersih[0]->saldo_akhir_bln_lalu : '0');
        $saldo_akhir_bln_lalu2 = (!empty($total_danabersih[1]->saldo_akhir_bln_lalu) ? $total_danabersih[1]->saldo_akhir_bln_lalu : '0');
