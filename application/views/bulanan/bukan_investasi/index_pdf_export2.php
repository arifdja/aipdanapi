...
<tr style="background-color: #d8d8d8; font-weight: bold;">
    <td></td>
    <td>Total</td>
    <td style="text-align: right;"><?=($sum_bukan_investasi['saldo_awal'] != 0 ) ? rupiah($sum_bukan_investasi['saldo_awal']) : '-';?></td>
    <td style="text-align: right;"><?=($sum_bukan_investasi['mutasi'] != 0 ) ? rupiah($sum_bukan_investasi['mutasi']) : '-';?></td>
    <td style="text-align: right;"><?=($sum_bukan_investasi['saldo_akhir'] != 0 ) ? rupiah($sum_bukan_investasi['saldo_akhir']) : '-';?></td>
</tr>
</table>
<br>
<!-- data keterangan  -->
