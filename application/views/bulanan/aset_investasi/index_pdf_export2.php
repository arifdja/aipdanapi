...
<table cellpadding="4px" cellspacing="0px" border="1" autosize="1" style="color:#000;background:#fff;font-size: 12px">
    ...
    <tr style="background-color: #d8d8d8; font-weight: bold;">
        <td></td>
        <td>Total</td>
        <td style="text-align: right;"><?=($sum_aset_investasi['rka'] != 0 ) ? rupiah($sum_aset_investasi['rka']) : '-';?></td>
        <td style="text-align: right;"><?=($sum_aset_investasi['saldo_awal'] != 0 ) ? rupiah($sum_aset_investasi['saldo_awal']) : '-';?></td>
        <td style="text-align: right;"><?=($sum_aset_investasi['mutasi'] != 0 ) ? rupiah($sum_aset_investasi['mutasi']) : '-';?></td>
        <td style="text-align: right;"><?=($sum_aset_investasi['saldo_akhir'] != 0 ) ? rupiah($sum_aset_investasi['saldo_akhir']) : '-';?></td>
        <td></td>
    </tr>  
</table>
<br>
