...
<tr style="background-color: #d8d8d8; font-weight: bold;">
	<td>Total</td>
	<td style="text-align: right;"><?=($sum_beban_investasi['saldo_akhir'] != 0 ) ? rupiah($sum_beban_investasi['saldo_akhir']) : '-';?></td>
	<td style="text-align: right;"><?=($sum_beban_investasi['saldo_akhir_lalu'] != 0 ) ? rupiah($sum_beban_investasi['saldo_akhir_lalu']) : '-';?></td>
	<td style="text-align: right;"><?=($sum_beban_investasi['rka'] != 0 ) ? rupiah($sum_beban_investasi['rka']) : '-';?></td>
	<td></td>
	<td></td>
	<td></td>
</tr>
