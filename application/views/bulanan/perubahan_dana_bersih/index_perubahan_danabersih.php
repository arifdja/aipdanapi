...
<?php $bln = $this->session->userdata('id_bulan');?>
<div class="row">
  <div class="col-xs-12">
        ...
        <div class="box-body" style="overflow-x:auto;">
          <div class="col-md-12">
            <div class="row">
              ...
              <div class="col-md-1">
                <div class="form-group adm">
                  <a href="javascript:void(0)" title="Add" class="btn btn-primary btn-sm btn-flat" onClick="gensearch('index-perubahan-danabersih','index-perubahan-danabersih');">
              ...
              <div  class="col-md-8"> 
                <div class="form-group pull-right">
                  <a href="javascript:void(0)" title="Add" class="btn btn-primary btn-sm btn-flat user-bln" onClick="genform('add', 'perubahan_dana_bersih','perubahan_dana_bersih');">
                  ...
                  &nbsp;&nbsp;
                  <!-- <a href="<?php echo site_url('bulanan/perubahan_dana_bersih/laporan_PerubahanDanaBersih_PDF').get_uri();?>" target="blank" class="btn btn-sm btn-danger btn-flat"><i class="fa fa-file-pdf-o"></i>&nbsp;&nbsp;Export PDF
                  </a> -->
          ...
          <div style="padding:4px;">
            ...
            <div style="padding:4px;border-style:groove;border-color:lightblue;">
              <p style="margin-left:0px;font-size: 14px;margin-right: 0px;margin-left: 0px;text-align: justify;"><?php echo (isset($data_perubahan_dana_bersih_ket[0]->keterangan_lap) ? $data_perubahan_dana_bersih_ket[0]->keterangan_lap : '');?></p>

              <p style="margin-left:0px;font-size: 14px;font-weight: bold">Dokumen :  <a href="<?php echo site_url('bulanan/perubahan_dana_bersih/get_file/'.(isset($data_perubahan_dana_bersih_ket[0]->id) ? $data_perubahan_dana_bersih_ket[0]->id : '').get_uri());?>"><p><?php echo (isset($data_perubahan_dana_bersih_ket[0]->file_lap) ? $data_perubahan_dana_bersih_ket[0]->file_lap : '');?></p></a></p>
            </div>
          </div>
          <!-- end keterangan -->
        </div>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="form-group form-group-sm">
              <form class="form-horizontal" action="<?php echo base_url().'bulanan/perubahan_dana_bersih/save_keterangan'?>" method="post" enctype="multipart/form-data">
                <input type="hidden" name="<?=$this->security->get_csrf_token_name();?>" value="<?=$this->security->get_csrf_hash();?>" style="display: none">
                <input type="hidden" name="jns_lap" value="ket_perubahan_dana_bersih">
                <input type="hidden" name="nmdok" value="Perubahan_Dana_Bersih">
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="keterangan">Keterangan</label>
                  <div class="col-sm-10">
                    <textarea name="keterangan" class="form-control" style="height:130px;width:100%;" id="keterangan" rows="10"><?php echo (isset($data_perubahan_dana_bersih_ket[0]->keterangan_lap) ? $data_perubahan_dana_bersih_ket[0]->keterangan_lap : '');?></textarea>
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 control-label" for="keterangan">Unggah Dokumen</label>
                  <div class="col-sm-10">
                    <input type="hidden" name="id" value="<?php echo (isset($data_perubahan_dana_bersih_ket[0]->id) ? $data_perubahan_dana_bersih_ket[0]->id : '');?>">
                    <input type="hidden" name="filedata" value="<?php echo (isset($data_perubahan_dana_bersih_ket[0]->file_lap) ? $data_perubahan_dana_bersih_ket[0]->file_lap : '');?>">
                    <input type="hidden" name="filedata_lama" value="<?php echo (isset($data_perubahan_dana_bersih_ket[0]->file_lap) ? $data_perubahan_dana_bersih_ket[0]->file_lap : '');?>">
                    <input type="file" name="filedata">
                    <p style="margin-top:10px;">File harus bertipe pdf,doc atau docx.</p>
                    <a href="<?php echo site_url('bulanan/perubahan_dana_bersih/get_file/'.(isset($data_perubahan_dana_bersih_ket[0]->id) ? $data_perubahan_dana_bersih_ket[0]->id : '').get_uri());?>"><p><?php echo (isset($data_perubahan_dana_bersih_ket[0]->file_lap) ? $data_perubahan_dana_bersih_ket[0]->file_lap : '');?></p></a>
                  </div>
                </div>
