...
class Peserta_aktif_semester_vTIP_model extends CI_Model
{
    ...
    {
        parent::__construct();
        $this->table = 'tbl_lkao_peserta_aktif_semester';
    ...
    public function get($semester = null, $tahun = null, $user = null)
    {
        ...
        $this->db->select('id,iduser,semester,tahun,id_kelompok,jumlah,rka');
